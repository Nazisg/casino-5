        ...
        >
            ...
            <div className="relative max-w-7xl mx-auto text-white text-center">
                <h2 className="text-[32px] md:text-[48px] xl:text-[64px] font-bold mb-3">
                    Find the Best
                    <span className="text-[#8A2BE2]"> UK Online Casinos</span>
                </h2>
                ...
                <a href="#top-casinos">
                    <button className="bg-[#8A2BE2] cursor-pointer rounded-[12px] mt-5 py-3 px-20 font-bold border border-[#8A2BE2] text-white">
                        Play Now
                    </button>
                </a>
            </div>
